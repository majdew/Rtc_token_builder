...
class RtcTokenController extends Controller
{
    ...
    {
        return RtcTokenController::buildTokenWithUserAccount($appID, $appCertificate, $channelName, $uid, $role, $privilegeExpireTs);
    }
    ...
    public static function buildTokenWithUserAccount($appID, $appCertificate, $channelName, $userAccount, $role, $privilegeExpireTs)
    {
        ...
        if (($role == RtcTokenController::RoleAttendee) ||
            ($role == RtcTokenController::RolePublisher) ||
            ($role == RtcTokenController::RoleAdmin)
        ) {
    ...
    public static function buildTokenWithUidAndPrivilege(
        ...
        return RtcTokenController::buildTokenWithUserAccountAndPrivilege(
            $appID,
            $appCertificate,
            $channelName,
            $uid,
